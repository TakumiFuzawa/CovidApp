...
class CircleChartViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        backButton.frame = CGRect(x: 10, y: 30, width: 100, height: 37)
    ...
    func dataSet() {
        ...
        let circleView = PieChartView(frame: CGRect(x: 0, y: 180, width: view.frame.size.width, height: 320))
        ...
        dataSet.colors = [
            colors.blue, colors.blueGreen, colors.yellowGreen, colors.yellowOrange, colors.redOrange
        ]
